...
def set_price(trade, asset_ticker, target_currency):
    ...
    if getattr(trade, price_attribute) is None:
        ...
        if transaction_date == today:
            ...
            set_historical_price(trade, asset_ticker, target_currency, transaction_date, price_attribute)

# set_historical_price for set_price
def set_historical_price(trade, asset_ticker, target_currency, transaction_date, price_attribute):
    try:
        ...
        if historical_price_currency == target_currency:
            ...
            set_converted_price(trade, asset_historical_price, historical_price_currency, target_currency, transaction_date, price_attribute)
...
def set_converted_price(trade, asset_historical_price, historical_price_currency, target_currency, transaction_date, price_attribute):
