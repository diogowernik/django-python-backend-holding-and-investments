...
class Command(BaseCommand):
    def handle(self, *args, **options):
        # HGLG, BRCO, KNRI, HGRE, HGBS, HGCR
        update_asset_dividends('HGLG11')
        update_asset_dividends('BRCO11')
        update_asset_dividends('KNRI11')
        update_asset_dividends('HGRE11')
        update_asset_dividends('HGBS11')
        update_asset_dividends('HGCR11')
