...
class CommonSetupMixin:
    ...
    def setUpTestData(cls):
        ...
        # two days ago for equity
        CurrencyHistoricalPrice.objects.create(currency_pair='BRLUSD', date=two_days_ago, open=0.20, high=0.20, low=0.20, close=0.20)
        CurrencyHistoricalPrice.objects.create(currency_pair='USDBRL', date=two_days_ago, open=5, high=5, low=5, close=5)
