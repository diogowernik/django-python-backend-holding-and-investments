...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        df_2['shares_amount'] = df_2['shares_amount'].str.replace('[A-Z]', '', regex=True)
        df_2 = df_2.set_index('ticker')        
        df_2 = df_2.merge(df, left_on="ticker",right_on="ticker",how='inner').set_axis(df_2.index)
        try:
            print(df_2)
