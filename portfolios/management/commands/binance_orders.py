...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        excel_file = "excel/ordens-binance.xlsx"
        ...
        df_2 = df_2[['Date(UTC)', 'Pair', 'Type',
                     'Order Amount', 'AvgTrading Price']]
        df_2.columns = ['date', 'ticker', 'order',
                        'shares_amount', 'share_cost_usd']
        ...
        df_3 = df_2.merge(df, left_on="ticker", right_on="ticker",
